...
def get_profile(session_id, device_id, iid):
    ...
    try:
        ...
        headers = {
            ...
            "user-agent": "com.zhiliaoapp.musically/432424234 (Linux; U; Android 5; en; fewfwdw; Build/PI;tt-ok/3.11.13.1)",
...
def change_username(session_id, device_id, iid, last_username, new_username):
    ...
    headers = {
        ...
        "user-agent": "com.zhiliaoapp.musically/{device_id} (Linux; U; Android 4; en; {iid}; Build/PI;tt-ok/3.11.13.1)",
...
def change_username_us(session_id, device_id, iid, last_username, new_username):
    ...
    parm = (f"aid=364225&sdk_version=1012000&refresh_num=11&version_code=30.0.0&language=en-SA"
            ...
            "&access=WIFI&carrier=stc&ac=WIFI&os_version=15.3&is_cold_start=0&reason=0&device_platform=iphone"
    ...
    if user != "None":
        ...
        while True:
            ...
            if "successful" in result:
                ...
                print(f"Failed to change username, retrying... Error: {result}")
        ...
        if user_us != "None":
            ...
            while True:
                ...
                result = change_username_us(session_id, device_id, iid, user_us, new_username)
